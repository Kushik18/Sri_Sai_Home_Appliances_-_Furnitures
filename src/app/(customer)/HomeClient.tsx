        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-8">
            {(isAppliance ? [
              ...
              { name: "Study/Office", desc: "Study tables, chairs, bookshelves", img: "/images/officechair2.webp", icon: <Ruler strokeWidth={1.5} className="w-4 h-4 sm:w-5 sm:h-5 text-white transition-transform duration-500 group-hover:rotate-12" />, count: "10 items" }
            ]).map((room, i) => (
